...
class Files extends \Phpcmf\Library\A_Field {
    ...
    public function input($field, $value = '') {
        ...
        $json = json_encode([
            ...
            'url' =>  dr_web_prefix('index.php?s=api&c=file&is_iframe&token='.dr_get_csrf_token()).'&siteid=' . SITE_ID . '&m=upload&p=' . $p . '&fid=' . $field['id'],
            'unused_url' => dr_web_prefix('index.php?s=api&c=file&m=input_file_list&is_iframe&token='.dr_get_csrf_token()).'&siteid='.SITE_ID.'&p=' . $p . '&fid=' . $field['id'],
            'input_url' => dr_web_prefix('index.php?s=api&c=file&m=input_file_url&is_iframe&token='.dr_get_csrf_token()).'&siteid='.SITE_ID.'&p='.$p.'&fid='.$field['id'],
