...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.llvideo', function () {
        return _this2.button({
          contents: _this2.ui.icon(_this2.options.icons.llvideo),
          tooltip: _this2.lang.options.llvideo,
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="form-group note-form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url form-control note-form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
        ...
        className: 'sn-checkbox-use-protocol hide',
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="form-group note-form-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label btn blue btn-sm fileinput-button">' + this.lang.image.selectFromFiles + '', '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input hide" ', ' type="file" name="files" accept="image/*" multiple="multiple"/></label>', imageLimitation, '</div>', '<div class="form-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + '</label>', '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control note-form-control note-input" type="text"/>', '</div>'].join('');
...
// CONCATENATED MODULE: ./src/js/base/module/LlvideoDialog.js
        function LlvideoDialog_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

        function LlvideoDialog_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

        function LlvideoDialog_createClass(Constructor, protoProps, staticProps) { if (protoProps) LlvideoDialog_defineProperties(Constructor.prototype, protoProps); if (staticProps) LlvideoDialog_defineProperties(Constructor, staticProps); return Constructor; }

        var LlvideoDialog_LlvideoDialog = /*#__PURE__*/function () {
          function LlvideoDialog(context) {
            LlvideoDialog_classCallCheck(this, LlvideoDialog);
          ...
          LlvideoDialog_createClass(LlvideoDialog, [{
            key: "initialize",
            value: function initialize() {
            ...
            key: "showLlvideoDialog",
            value: function showLlvideoDialog() {
            ...
            value: function show() {
              ...
              var url = _this.options.llVideoUrl+"&ct=0&rand=" + Math.random();
              layer.open({
                type: 2,
...
var HelpDialog_HelpDialog = /*#__PURE__*/function () {
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function show() {
      ...
      var url = _this.options.llImageUrl+"&ct=0&rand=" + Math.random();
      layer.open({
        type: 2,
        title: '<i class="fa fa-folder-open"></i>',
        fix:true,
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    icons: {
      ...
      'rowBelow': 'bi bi-arrow-bar-down',
      'colBefore': 'bi bi-arrow-bar-left',
      'colAfter': 'bi bi-arrow-bar-right',
      'rowAbove': 'bi bi-arrow-bar-up',
      'rowRemove': 'bi bi-backspace-fill',
      'colRemove': 'bi bi-backspace-reverse-fill',
      'indent': 'fa fa-indent',
      ...
      'code': 'fa fa-code',
      'eraser': 'fa fa-eraser',
      'floatLeft': 'fa fa-chevron-left',
      'floatRight': 'fa fa-chevron-right',
      'font': 'fa fa-font',
      'frame': 'fa fa-file',
      'italic': 'fa fa-italic',
      'link': 'fa fa-link',
      ...
      'pencil': 'fa fa-pencil',
      'picture': 'bi bi-card-image',
      'question': 'bi bi-images',
      'redo': 'fa fa-redo',
      'rollback': 'fa fa-close',
      'square': 'fa fa-square',
...
var statusbar = renderer["a" /* default */].create(['<output class="note-status-output" role="status" aria-live="polite"></output>', '<div class="note-statusbar" role="status">', '<div class="note-resizebar" aria-label="Resize">', '<div class="fa fa-bar"></div>', '<div class="fa fa-bar"></div>', '<div class="fa fa-bar"></div>', '</div>', '</div>'].join(''));
